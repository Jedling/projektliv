      ...
      <div class="row">
        <div class="col-12 mb-3">
          <figure>
            <img
              class="schedule-img"
              src="../assets/schedule/schema.jpg"
            ...
            <div class="timetable-container flex">
              <div class="days-wrap flex">
                <div class="day flex">
                  ...
                  <div class="class-container flex color color--scheme1">
                    <span class="time">09:45-10:15</span>
...
.home-btn {
  font-size: 50px;
  color: rgb(132, 76, 147);
  padding: 0px;
}
.home-btn:hover {
  color: rgb(119, 26, 145);
}
.schedule-img {
  width: 100%;
  height: 400px;
